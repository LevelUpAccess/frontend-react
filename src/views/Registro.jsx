...
import Spinner from '../components/Spinner'; // Asegúrate de que el path sea correcto
...
export default function Registro() {
  ...
  // Eliminamos el estado 'loading' local aquí, ya que useAuth lo manejará
  // const [loading, setLoading] = useState(false); 

  const [errores, setErrores] = useState([]);
  // Desestructuramos 'authLoading' del hook useAuth
  const { registro, authLoading } = useAuth({ middleware: 'guest', url: '/' });
  ...
  const handleSubmit = async e => {
    ...
    // Aquí simplemente llamamos a la función de registro.
  ...
  // Ahora, si 'authLoading' (del hook useAuth) es true, muestra el Spinner.
